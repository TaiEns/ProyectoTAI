        ...
        <div class="container">
            <div class="shadow-lg p-3 mb-5 bg-white rounded">
              <div class="text-center mb-4">
                <h1 class="h3 mb-3 font-weight-bold">Datos del Solicitante</h1>
              </div>
              ...
              <div class="form-row form-input">
                ...
                <div class="col-md-4 mb-3">
                  ...
                  <asp:TextBox ID="Calle" runat="server" class="form-control" placeholder="Dirección" ></asp:TextBox>
                </div>
              </div>
              <div class="form-row form-input">
                  <div class="col-md-4 mb-3">
                  ...
                  <div class="col-md-4 mb-3">
                      ...
                      <asp:TextBox ID="Tipo" runat="server" class="form-control" placeholder="Tipo" ></asp:TextBox>
                      <label for="DLaborales">Días laborales</label>
                      <asp:TextBox ID="DLaborales" runat="server" class="form-control" placeholder="Dias laborales" ></asp:TextBox>
